...
int main() {
    ...
    if (!cuda_ok(cudaMalloc(reinterpret_cast<void**>(&density), scalar_bytes), "cudaMalloc density") ||
        ...
        !cuda_ok(cudaMalloc(reinterpret_cast<void**>(&temporary_density), temporary_field_bytes), "cudaMalloc temporary_density") ||
        !cuda_ok(cudaMalloc(reinterpret_cast<void**>(&temporary_velocity_x), temporary_field_bytes), "cudaMalloc temporary_velocity_x") ||
        !cuda_ok(cudaMalloc(reinterpret_cast<void**>(&temporary_velocity_y), temporary_field_bytes), "cudaMalloc temporary_velocity_y") ||
        !cuda_ok(cudaMalloc(reinterpret_cast<void**>(&temporary_velocity_z), temporary_field_bytes), "cudaMalloc temporary_velocity_z") ||
        !cuda_ok(cudaMalloc(reinterpret_cast<void**>(&temporary_previous_density), temporary_field_bytes), "cudaMalloc temporary_previous_density") ||
        !cuda_ok(cudaMalloc(reinterpret_cast<void**>(&temporary_previous_velocity_x), temporary_field_bytes), "cudaMalloc temporary_previous_velocity_x") ||
        !cuda_ok(cudaMalloc(reinterpret_cast<void**>(&temporary_previous_velocity_y), temporary_field_bytes), "cudaMalloc temporary_previous_velocity_y") ||
        !cuda_ok(cudaMalloc(reinterpret_cast<void**>(&temporary_previous_velocity_z), temporary_field_bytes), "cudaMalloc temporary_previous_velocity_z") ||
        !cuda_ok(cudaMalloc(reinterpret_cast<void**>(&temporary_pressure), temporary_field_bytes), "cudaMalloc temporary_pressure") ||
        !cuda_ok(cudaMalloc(reinterpret_cast<void**>(&temporary_divergence), temporary_field_bytes), "cudaMalloc temporary_divergence") ||
